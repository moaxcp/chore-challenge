...
<html>
    ...
    <body>
        <a href="#edit-chore" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-chore" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.chore}" method="PUT">
                <g:hiddenField name="version" value="${this.chore?.version}" />
                <fieldset class="form">
                    <f:with bean="chore">
